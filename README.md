# 🎼 Music Slot Booking — Music Academy & Smart Booking System

A Progressive Web App (PWA) and Academy Management System for Music Coaches and Students.

> Scheduling from 5:00 AM to 11:00 PM across 10 Studio Instruments.

---

## 🌟 Features & Portals

1. **Music Coach Master Portal**: Chronological daily schedule (5:00 AM to 11:00 PM), attendance override, feedback/homework log, PDF generation, and WhatsApp automation.
...
3. **Flexible Session Booking Portal**: Free slots discovery across Morning, Afternoon, and Evening, with 1-tap booking.
4. **Automated Web Push Notifications**:
   - ⏰ **1 Hour Before Alert**: Reminds Coach who is coming + prompts student to attend or mark absent.
   ...
   - ⚠️ **Instant Absent Alert**: Notifies Coach immediately when a student marks "Can't make it".
   - ⚡ **Instant Booking Alert**: Notifies Coach when a flexible student requests a slot.
5. **PDF Progress Reports**: 1-click auto-generated student attendance & evaluation pdf certificates.
6. **PWA Installable**: Standalone app for iOS Safari (16.4+) and Android Chrome.
